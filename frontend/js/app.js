  ...
  return `
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-2 gap-3">
        <button onclick="document.querySelector('[x-data]').__x.$data.navigate('abordagem-nova')"
        ...
        <button onclick="document.querySelector('[x-data]').__x.$data.navigate('consulta')"
                class="card text-center py-6 hover:border-blue-500 transition-colors cursor-pointer">
        ...
        <button onclick="document.querySelector('[x-data]').__x.$data.navigate('ocorrencia-upload')"
                class="card text-center py-6 hover:border-blue-500 transition-colors cursor-pointer">
        ...
        <button onclick="document.querySelector('[x-data]').__x.$data.navigate('rag-relatorio')"
                class="card text-center py-6 hover:border-blue-500 transition-colors cursor-pointer">
      ...
      <div class="card">
        ...
        <button onclick="document.querySelector('[x-data]').__x.$data.navigate('dashboard')"

...
| G9-6 | Fixture `setup_db` autouse acopla unit ao banco | Resolvido (achado #32/2026-07-13): `setup_db` deixou de ser autouse; virou dependência de `db_session`/`client`. Zero opt-in por arquivo — os ~50 arquivos unit sem `db_session`/`client` param de tocar o banco automaticamente | `PENDENTE` |

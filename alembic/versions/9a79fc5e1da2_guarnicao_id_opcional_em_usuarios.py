...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        "fk_abordagens_desativado_por_id",
        "abordagens",
        "usuarios",
        ["desativado_por_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "fk_enderecos_pessoa_desativado_por_id",
        "enderecos_pessoa",
        "usuarios",
        ["desativado_por_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "fk_guarnicoes_desativado_por_id",
        "guarnicoes",
        "usuarios",
        ["desativado_por_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "fk_ocorrencias_desativado_por_id",
        "ocorrencias",
        "usuarios",
        ["desativado_por_id"],
        ["id"],
...
def downgrade() -> None:
    ...
    op.drop_constraint(
        "fk_enderecos_pessoa_desativado_por_id", "enderecos_pessoa", type_="foreignkey"
    )

"""guarnicao_id opcional em usuarios

Revision ID: 9a79fc5e1da2
Revises: 08ef2221d8ba
Create Date: 2026-03-03 00:06:01.781354
...
revision: str = '9a79fc5e1da2'
down_revision: Union[str, None] = '08ef2221d8ba'
...
def upgrade() -> None:
    ...
    op.create_foreign_key('fk_abordagens_desativado_por_id', 'abordagens', 'usuarios', ['desativado_por_id'], ['id'], use_alter=True)
    op.create_foreign_key('fk_enderecos_pessoa_desativado_por_id', 'enderecos_pessoa', 'usuarios', ['desativado_por_id'], ['id'], use_alter=True)
    op.create_foreign_key('fk_fotos_desativado_por_id', 'fotos', 'usuarios', ['desativado_por_id'], ['id'], use_alter=True)
    op.create_foreign_key('fk_guarnicoes_desativado_por_id', 'guarnicoes', 'usuarios', ['desativado_por_id'], ['id'], use_alter=True)
    op.create_foreign_key('fk_ocorrencias_desativado_por_id', 'ocorrencias', 'usuarios', ['desativado_por_id'], ['id'], use_alter=True)
    op.create_foreign_key('fk_pessoas_desativado_por_id', 'pessoas', 'usuarios', ['desativado_por_id'], ['id'], use_alter=True)
    op.alter_column('usuarios', 'guarnicao_id',
               existing_type=sa.INTEGER(),
               nullable=True)
    op.create_foreign_key('fk_usuarios_desativado_por_id', 'usuarios', 'usuarios', ['desativado_por_id'], ['id'], use_alter=True)
    op.create_foreign_key('fk_veiculos_desativado_por_id', 'veiculos', 'usuarios', ['desativado_por_id'], ['id'], use_alter=True)
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint('fk_veiculos_desativado_por_id', 'veiculos', type_='foreignkey')
    op.drop_constraint('fk_usuarios_desativado_por_id', 'usuarios', type_='foreignkey')
    op.alter_column('usuarios', 'guarnicao_id',
               existing_type=sa.INTEGER(),
               nullable=False)
    op.drop_constraint('fk_pessoas_desativado_por_id', 'pessoas', type_='foreignkey')
    op.drop_constraint('fk_ocorrencias_desativado_por_id', 'ocorrencias', type_='foreignkey')
    op.drop_constraint('fk_guarnicoes_desativado_por_id', 'guarnicoes', type_='foreignkey')
    op.drop_constraint('fk_fotos_desativado_por_id', 'fotos', type_='foreignkey')
    op.drop_constraint('fk_enderecos_pessoa_desativado_por_id', 'enderecos_pessoa', type_='foreignkey')
    op.drop_constraint('fk_abordagens_desativado_por_id', 'abordagens', type_='foreignkey')

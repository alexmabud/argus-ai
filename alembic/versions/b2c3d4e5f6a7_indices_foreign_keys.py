...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_abordagens_usuario_id"), "abordagens", ["usuario_id"])
    op.create_index(op.f("ix_fotos_pessoa_id"), "fotos", ["pessoa_id"])
    op.create_index(op.f("ix_fotos_abordagem_id"), "fotos", ["abordagem_id"])
    op.create_index(op.f("ix_ocorrencias_abordagem_id"), "ocorrencias", ["abordagem_id"])
    op.create_index(op.f("ix_ocorrencias_usuario_id"), "ocorrencias", ["usuario_id"])
    op.create_index(op.f("ix_enderecos_pessoa_pessoa_id"), "enderecos_pessoa", ["pessoa_id"])
    op.create_index(
